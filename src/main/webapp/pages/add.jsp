...
<title>Add Students</title>
    <style>
        body {
            ...
            background-image: url('/pages/images/image.jpg');
        ...
        input[type="text"],input[type="date"], input[type="submit"], input[type="button"] {
            width: 100%;
            padding: 9px;
            margin-top: 1px;
            border-radius: 8px;
...
<h2>Student Details</h2>
    <form method="post" action="submit">
        ...
        <input type="text" id="Fathername" name="Fathername" placeholder="FatherName" required><br><br>
        
        <label for="Mothername">Enter a MotherName</label><br>
        <input type="text" id="Mothername" name="Mothername" placeholder="MotherName"required><br><br>
